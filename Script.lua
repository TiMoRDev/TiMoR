...
if Status or Dev_TiMoR(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if hash or Dev_TiMoR(msg) or DeveloperBot(msg) or Bot(msg) then  
return true 
else 
return false 
end 
...
if hash or Dev_TiMoR(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or Dev_TiMoR(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or Dev_TiMoR(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Owner(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or Dev_TiMoR(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Owner(msg) or Admin(msg) or Bot(msg) then     
return true 
else 
return false 
end 
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
elseif text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_TiMoR(msg) then
end
function FunctionStatus(arg, result)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
elseif text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_TiMoR(msg) then
end
function FunctionStatus(arg, result)
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^الغاء العام @(.*)$") }, FunctionStatus, nil)
elseif text and text:match("^اضف مطور @(.*)$") and Dev_TiMoR(msg) then
end
function FunctionStatus(arg, result)
if (result.id_) then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^اضف مطور @(.*)$")}, FunctionStatus, nil)
elseif text and text:match("^حذف مطور @(.*)$") and Dev_TiMoR(msg) then
end
function FunctionStatus(arg, result)
if (result.id_) then
redis:srem(bot_id.."Developer:Bot", result.id_)
...
elseif text and text:match("^حذف مطور (%d+)$") and Dev_TiMoR(msg) then
end
...
elseif text and text:match("^رفع مميز (%d+)$") and Admin(msg) the
end 
if not Constructor(msg) and redis:get(bot_id.."Status:Cheking:Seted"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'ܛ لا تستطيع رفع احد وذالك لان تم تعطيل الرفع من قبل المنشئين')
return false
...
Send_Options(msg,userid,"reply","ܛ تم تقييده في المجموعه")  
end
