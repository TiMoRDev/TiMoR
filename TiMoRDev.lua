...
Reply_Status(msg,msg.sender_user_id_,"reply","📬┇"..TiMoRDev_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
...
if text == (database:get(bot_id.."TiMoRDev:Name:Bot") or "بلاك") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."TiMoRDev:Name:Bot") or "بلاك")
local namebot = {
...
send(msg.chat_id_, msg.id_,'👥┇عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'TiMoRDev:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
...
local Name_Bot = (database:get(bot_id.."TiMoRDev:Name:Bot") or "بلاك")
...
if TiMoRDev_Msg then    
Reply_Status(result,result.sender_user_id_,"reply","📬┇"..TiMoRDev_Msg)  
DeleteMessage(result.chat_id_, {[0] = data.message_id_})     
return false
end
end
