...
Ids_Dev = {sudos.Id_DevTiMoR,373906612,bot_id}
...
url = 'https://raw.githubusercontent.com/TiMoRkid/TiMoR/master/Script.lua'
...
url = 'https://raw.githubusercontent.com/TiMoRkid/TiMoR/master/TiMoR.lua'
file_path = 'TiMoR.lua'
local respbody = {} 
local options = { url = url, sink = ltn12.sink.table(respbody), redirect = true } 
local response = nil 
...
download_to_file('https://raw.githubusercontent.com/TiMoRkid/TiMoR/master/TiMoR.lua','TiMoR.lua') 
download_to_file('https://raw.githubusercontent.com/TiMoRkid/TiMoR/master/Script.lua','Script.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/TiMoRkid/Files_TiMoR/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
if Get_info then
local TextS = "\n⌔︙قائمه ملفات متجر سورس TiMoR\n⌔︙الملفات المتوفره حاليا\n━━━━━━━━━━━━━\n\n"
...
local Get_Json, Res = https.request("https://raw.githubusercontent.com/TiMoRkid/Files_TiMoR/master/Files_TiMoR/"..File_Name)
if Res == 200 then
...
send(msg.chat_id_, msg.id_,'*⌔︙ عدد المجموعات الان ← { '..#group..' } مجموعه '..TiMoR..''..taha..'\n⌔︙اصبح عدد المجموعات الان ← { '..sendok..' } مجموعات*\n')   
end
end
end,nil)
end
...
𓂅 . [Source Info ](t.me/TiMoR0)     

𓂅 . [TiMoR iNDT](t.me/TiMoR0)     
 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
𓂅 . [TWS TiMoR](t.me/Ub55bot)     
]]) 
